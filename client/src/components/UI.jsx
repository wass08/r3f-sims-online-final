...
const PasswordInput = ({ onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed z-10 grid place-items-center w-screen h-screen top-0 left-0">
      <div
        className="absolute top-0 left-0 w-screen h-screen bg-black bg-opacity-50 backdrop-blur-sm"
        onClick={onClose}
      ></div>
      ...
      >
        {avatarMode && (
          <AvatarCreator
            ...
            className="fixed top-0 left-0 z-[999999999] w-screen h-screen" // have to put a crazy z-index to be on top of HTML generated by Drei
